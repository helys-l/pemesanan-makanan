...
import EditMakananForm from "../elements/EditMinumanForm.jsx";
import AddMakananForm from "../elements/AddMinumanForm.jsx"; 
...
export default function MakananListFirebase() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        setLoading(true);
        const col = collection(db, "minuman");
        ...
        setError("Gagal memuat data minuman");
        setLoading(false);
        console.error(err);
      }
    }
 ...
 const handleDelete = async (item) => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl md:text-2xl font-bold text-[#DC2318] mb-4">Minuman</h2>
