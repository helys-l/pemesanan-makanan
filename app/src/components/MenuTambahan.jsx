...
import { menuTambahan } from "../data/Data";

export default function MenuTambahan({addToOrder}) {
  const [selectedItem, setSelectedItem] = useState(menuTambahan[0]);
  const [quantity, setQuantity] = useState(1);
  const [selectedLevel, setSelectedLevel] = useState(menuTambahan[0].level[0]);
