...
export default function EditMakananForm({ item, onCancel, onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const docRef = doc(db, "makanan", item.id);
      ...
      onSave({ ...item, nama, deskripsi, harga: Number(harga), gambar, level });
      setLoading(false);
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
      ...
      >
        <h3 className="text-xl font-bold mb-4">Edit Menu Tambahan</h3>
